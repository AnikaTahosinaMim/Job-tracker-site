let interViews = [];
let rejected = [];
let currentStatus = "all-btn"; // Default status matches the ID
...
// 3. Main Container Click Listener
...
mainContainer.addEventListener("click", function (event) {
  ...
  if (event.target.classList.contains("btn-delete")) {
    ...
    card.remove(); // Remove from all cards
